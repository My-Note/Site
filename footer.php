...
<!-- FOOTER -->
      <footer>
		...
		<?php 
			if (($page_active != "message.php") and ($page_active != "index.php")) {
				include('chat.php'); 
			}
		?>
		...
		<!-- CONTACTS SCRIPT--
		<script type="text/javascript" src="<?php echo $back_page; ?>public/js/contact.js"></script>
		<!-- / CONTACTS SCRIPT-->

		<!-- Classie - class helper functions by @desandro https://github.com/desandro/classie -->
		<script src="<?php echo $back_page; ?>public/jquery/classie.js"></script>

		<?php 
			if ($page_active != "index.php") {
		?>
				<script src='public/jquery/uisearch.js'></script>
				<script>
